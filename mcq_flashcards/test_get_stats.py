...
class TestGetStats(unittest.TestCase):
    ...
    def test_get_stats_success(self, mock_load):
        ...
        mock_load.return_value = {
            ...
            '3': {'id': '3', 'question': 'Q3', 'answer': 'A3', 'choices': ['A3', 'W7', 'W8', 'W9'], 'used': True}
        }
    ...
    def test_get_stats_all_used(self, mock_load):
        ...
        mock_load.return_value = {
            '1': {'id': '1', 'question': 'Q1', 'answer': 'A1', 'choices': ['A1', 'W1', 'W2', 'W3'], 'used': True},
            '2': {'id': '2', 'question': 'Q2', 'answer': 'A2', 'choices': ['A2', 'W4', 'W5', 'W6'], 'used': True}
        }
    ...
    def test_get_stats_none_used(self, mock_load):
        ...
        mock_load.return_value = {
            '1': {'id': '1', 'question': 'Q1', 'answer': 'A1', 'choices': ['A1', 'W1', 'W2', 'W3'], 'used': False},
            '2': {'id': '2', 'question': 'Q2', 'answer': 'A2', 'choices': ['A2', 'W4', 'W5', 'W6'], 'used': False}
        }
